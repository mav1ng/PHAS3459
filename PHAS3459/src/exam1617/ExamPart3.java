...
public class ExamPart3 {
	...
	public static String dataAnalysis(Sound s, Classification cla) {
			return (cla.classify(s));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------------Data Classification 2 --------------------------");
		
		RangeClassification rC = new RangeClassification();
		
		for (Sound s: alSound) {
			System.out.println(dataAnalysis(s, rC));
			System.out.println();
		}
